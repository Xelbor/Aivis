...
def search_for_video_on_youtube():
    ...
    if 'у меня всё хорошо' or 'у меня всё отлично' or 'у меня всё супер' or 'у меня всё нормально' or 'хорошо' or 'отлично' or 'супер' and 'нормально' in app.commands():
        z = ["Это прекрасно!", "Это хорошо!", "Отлично!", "Супер!", "Класс!"]
        x = random.choice(z)
        voice.va_speak(x)

    elif 'всё плохо' or 'так себе' or 'плохо' or 'не очень' and 'такое себе' in app.commands():
...
def doing1():
    ...
    if 'ничего' or 'видео смотрел' or 'в интернете сидел' or 'фотки смотрел' or 'картинки смотрел' or 'в телефоне сидел' or 'в компьютере сидел' or 'телевизор смотрел' or 'сижу' or 'лежу' and 'общаюсь с тобой' in app.commands():
        z = ["Ясно", "Понятно"]
        x = random.choice(z)
        voice.va_speak(x)
